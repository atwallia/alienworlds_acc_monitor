...
export default function Home(props) {
  ...
  const genLink = props.urlAcc ? 'https://www.alienworlds.fun/?accounts='+btoa(JSON.stringify(props.urlAcc)) : cookies.get("accounts") ? 'https://alienworlds.netlify.app/?accounts='+btoa(JSON.stringify(cookies.get("accounts"))) : "Please add some accounts first!"
